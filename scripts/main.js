...
$(document).ready(function() {
  ...
  if (
    ...
    $("#baconianinfo").removeAttr("hidden");
  ...
  if (cipher != "") {
    ...
    if (input != "") {
      switch (cipher) {
        case "ROT":
          if (
            !isNaN(parseInt($("#numberofrot").val())) ||
            $("#numberofrot").val() != ""
          ) {
            $("#outputbox").val(
              rotEncrypt(input, parseInt($("#numberofrot").val()), 1)
            );
            $("#inputbox").val("");
          }
          break;
        ...
        case "Rail Fence":
          if (
            !isNaN(parseInt($("#numberofrail").val())) ||
            $("#numberofrail").val() != ""
          ) {
            $("#outputbox").val(
              railfenceEncrypt(input, parseInt($("#numberofrail").val()), 1)
            );
            $("#inputbox").val("");
          }
          break;
      ...
      switch (cipher) {
        case "ROT":
          if (
            ...
            $("#outputbox").val(
              rotEncrypt(input, parseInt($("#numberofrot").val()), 0)
            );
            $("#inputbox").val("");
          }
          break;
        ...
        case "Rail Fence":
          if (
            ...
            $("#outputbox").val(
              railfenceEncrypt(input, parseInt($("#numberofrail").val()), 0)
            );
            $("#inputbox").val("");
          }
          break;
